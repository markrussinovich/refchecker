...
A native desktop wrapper around the [RefChecker](https://github.com/markrussinovich/refchecker) web UI for macOS, Windows, and Linux. Built with [Tauri 2.x](https://tauri.app).
