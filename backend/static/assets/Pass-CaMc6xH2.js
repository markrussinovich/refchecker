...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bs(e,t,n){let r=new Float32Array(Es),i=new J(0,1,0);return new Pa({name:`SphericalGaussianBlur`,defines:{n:Es,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Us(),fragmentShader:`
	...
	`}var Ws=class extends nn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Hi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Au=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},ju=new Mo(-1,1,1,-1,0,1),Mu=new class extends Vr{constructor(){super(),this.setAttribute(`position`,new kr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new kr([0,2,0,0,2,0],2))}},Nu=class{constructor(e){this._mesh=new mi(Mu,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,ju)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}};export{Ri as $,x as $n,ve as $t,Ui as A,Ie as An,jo as At,Pn as B,qr as Bn,te as Bt,qi as C,n as Cn,a as Ct,Ge as D,B as Dn,Do as Dt,Ue as E,ue as En,Mo as Et,kr as F,p as Fn,ht as Ft,vi as G,Uo as Gn,we as Gt,ho as H,t as Hn,be as Ht,_ as I,Nr as In,ke as It,Hr as J,Er as Jn,L as Jt,rs as K,Ze as Kn,Te as Kt,Vi as L,Ca as Ln,Oe as Lt,Je as M,Hn as Mn,ba as Mt,dt as N,Pa as Nn,Lt as Nt,D as O,z as On,Si as Ot,Or as P,Ta as Pn,le as Pt,Ro as Q,C as Qn,_e as Qt,Ei as R,cs as Rn,de as Rt,ga as S,tn as Sn,i as St,_i as T,ut as Tn,o as Tt,He as U,$t as Un,xe as Ut,v as V,qe as Vn,Ce as Vt,We as W,po as Wn,Se as Wt,Ke as X,ja as Xn,he as Xt,Wr as Y,Dr as Yn,me as Yt,Be as Z,d as Zn,ge as Zt,Ji as _,ti as _n,U as _r,Ba as _t,w as a,P as an,q as ar,Le as at,Wi as b,k as bn,Ia as bt,rr as c,T as cn,Ye as cr,Kr as ct,Vr as d,I as dn,In as dr,Y as dt,ye as en,S as er,Ai as et,f,ae as fn,nt as fr,on as ft,Qe as g,ee as gn,at as gr,Wa as gt,X as h,j as hn,et as hr,Va as ht,Ou as i,F as in,m as ir,l as it,Po as j,ze as jn,Bi as jt,O as k,fe as kn,Sa as kt,Ki as l,M as ln,nn as lr,It as lt,Z as m,N as mn,ds as mr,ni as mt,Au as n,ce as nn,y as nr,c as nt,Fo as o,ne as on,J as or,Re as ot,r as p,ie as pn,W as pr,mi as pt,h as q,wa as qn,pe as qt,ku as r,oe as rn,b as rr,u as rt,Ho as s,re as sn,en as sr,e as st,Nu as t,Ee as tn,g as tr,Ga as tt,Tr as u,se as un,Xe as ur,ls as ut,us as v,as as vn,st as vr,Ra as vt,rn as w,Ve as wn,s as wt,Hi as x,A as xn,za as xt,Vo as y,Io as yn,ct as yr,La as yt,ki as z,ko as zn,E as zt};