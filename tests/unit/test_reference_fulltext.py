...
def test_fulltext_capped_to_chat_grounding_budget(monkeypatch):
    ...
    # mirror, so the two bounds can't silently drift apart.
    from backend.article_chat import MAX_GROUNDING_CHARS
    assert rf._MAX_FULLTEXT_CHARS == MAX_GROUNDING_CHARS
