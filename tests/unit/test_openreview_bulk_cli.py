...
def test_parse_openreview_venue_spec_accepts_shorthand():
    venue_info = OpenReviewReferenceChecker.parse_venue_spec('neurips-2024')

    assert venue_info['series'] == 'NeurIPS'
    assert venue_info['year'] == 2024
    assert venue_info['accepted_venue'] == 'NeurIPS 2024 Conference'
    assert venue_info['submission_invitation'] == 'NeurIPS.cc/2024/Conference/-/Submission'
